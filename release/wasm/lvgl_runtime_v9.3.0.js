...
var ASM_CONSTS = {
  1084704: ($0) => { startToDebuggerMessage($0); },  
 1084736: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1084811: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1084886: ($0) => { finishToDebuggerMessage($0); },  
 1084919: ($0, $1) => { lvglCreateScreen($0, $1); },  
 1084949: ($0, $1) => { lvglDeleteScreen($0, $1); },  
 1084979: ($0) => { lvglScreenTick($0); },  
 1085003: ($0, $1, $2, $3) => { lvglOnEventHandler($0, $1, $2, $3); },  
 1085043: ($0, $1) => { return getLvglScreenByName($0, UTF8ToString($1)); },  
 1085097: ($0, $1) => { return getLvglObjectByName($0, UTF8ToString($1)); },  
 1085151: ($0, $1) => { return getLvglGroupByName($0, UTF8ToString($1)); },  
 1085204: ($0, $1) => { return getLvglStyleByName($0, UTF8ToString($1)); },  
 1085257: ($0, $1) => { return getLvglImageByName($0, UTF8ToString($1)); },  
 1085310: ($0, $1) => { return getLvglFontByName($0, UTF8ToString($1)); },  
 1085362: ($0, $1) => { return getLvglObjectNameFromIndex($0, $1); },  
 1085409: ($0, $1, $2) => { lvglObjAddStyle($0, $1, $2); },  
 1085442: ($0, $1, $2) => { lvglObjRemoveStyle($0, $1, $2); },  
 1085478: ($0, $1) => { lvglSetColorTheme($0, UTF8ToString($1)); },  
 1085523: ($0, $1, $2, $3, $4, $5) => { return eez_mqtt_init($0, UTF8ToString($1), UTF8ToString($2), $3, UTF8ToString($4), UTF8ToString($5)); },  
 1085629: ($0, $1) => { return eez_mqtt_deinit($0, $1); },  
 1085665: ($0, $1) => { return eez_mqtt_connect($0, $1); },  
 1085702: ($0, $1) => { return eez_mqtt_disconnect($0, $1); },  
 1085742: ($0, $1, $2) => { return eez_mqtt_subscribe($0, $1, UTF8ToString($2)); },  
 1085799: ($0, $1, $2) => { return eez_mqtt_unsubscribe($0, $1, UTF8ToString($2)); },  
 1085858: ($0, $1, $2, $3) => { return eez_mqtt_publish($0, $1, UTF8ToString($2), UTF8ToString($3)); }
};
