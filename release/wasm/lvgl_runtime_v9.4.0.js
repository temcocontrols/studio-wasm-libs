...
// include: C:/QN/temcocontrols/studio-wasm-libs/lvgl-runtime/v9.4.0/../common/pre.js
...
// end include: C:/QN/temcocontrols/studio-wasm-libs/lvgl-runtime/v9.4.0/../common/pre.js
...
var ASM_CONSTS = {
  1089872: ($0) => { startToDebuggerMessage($0); },  
 1089904: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1089979: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1090054: ($0) => { finishToDebuggerMessage($0); },  
 1090087: ($0, $1) => { lvglCreateScreen($0, $1); },  
 1090117: ($0, $1) => { lvglDeleteScreen($0, $1); },  
 1090147: ($0) => { lvglScreenTick($0); },  
 1090171: ($0, $1, $2, $3) => { lvglOnEventHandler($0, $1, $2, $3); },  
 1090211: ($0, $1) => { return getLvglScreenByName($0, UTF8ToString($1)); },  
 1090265: ($0, $1) => { return getLvglObjectByName($0, UTF8ToString($1)); },  
 1090319: ($0, $1) => { return getLvglGroupByName($0, UTF8ToString($1)); },  
 1090372: ($0, $1) => { return getLvglStyleByName($0, UTF8ToString($1)); },  
 1090425: ($0, $1) => { return getLvglImageByName($0, UTF8ToString($1)); },  
 1090478: ($0, $1) => { return getLvglFontByName($0, UTF8ToString($1)); },  
 1090530: ($0, $1) => { return getLvglObjectNameFromIndex($0, $1); },  
 1090577: ($0, $1, $2) => { lvglObjAddStyle($0, $1, $2); },  
 1090610: ($0, $1, $2) => { lvglObjRemoveStyle($0, $1, $2); },  
 1090646: ($0, $1) => { lvglSetColorTheme($0, UTF8ToString($1)); },  
 1090691: ($0, $1, $2, $3, $4, $5) => { return eez_mqtt_init($0, UTF8ToString($1), UTF8ToString($2), $3, UTF8ToString($4), UTF8ToString($5)); },  
 1090797: ($0, $1) => { return eez_mqtt_deinit($0, $1); },  
 1090833: ($0, $1) => { return eez_mqtt_connect($0, $1); },  
 1090870: ($0, $1) => { return eez_mqtt_disconnect($0, $1); },  
 1090910: ($0, $1, $2) => { return eez_mqtt_subscribe($0, $1, UTF8ToString($2)); },  
 1090967: ($0, $1, $2) => { return eez_mqtt_unsubscribe($0, $1, UTF8ToString($2)); },  
 1091026: ($0, $1, $2, $3) => { return eez_mqtt_publish($0, $1, UTF8ToString($2), UTF8ToString($3)); }
};
...
// include: C:/QN/temcocontrols/studio-wasm-libs/lvgl-runtime/v9.4.0/../common/post.js
}
// end include: C:/QN/temcocontrols/studio-wasm-libs/lvgl-runtime/v9.4.0/../common/post.js
