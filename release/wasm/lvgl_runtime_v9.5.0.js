...
// end include: C:/QN/temcocontrols/studio-wasm-libs/lvgl-runtime/v9.5.0/../common/pre.js
...
var ASM_CONSTS = {
  1093168: ($0) => { startToDebuggerMessage($0); },  
 1093200: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1093275: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1093350: ($0) => { finishToDebuggerMessage($0); },  
 1093383: ($0, $1) => { lvglCreateScreen($0, $1); },  
 1093413: ($0, $1) => { lvglDeleteScreen($0, $1); },  
 1093443: ($0) => { lvglScreenTick($0); },  
 1093467: ($0, $1, $2, $3) => { lvglOnEventHandler($0, $1, $2, $3); },  
 1093507: ($0, $1) => { return getLvglScreenByName($0, UTF8ToString($1)); },  
 1093561: ($0, $1) => { return getLvglObjectByName($0, UTF8ToString($1)); },  
 1093615: ($0, $1) => { return getLvglGroupByName($0, UTF8ToString($1)); },  
 1093668: ($0, $1) => { return getLvglStyleByName($0, UTF8ToString($1)); },  
 1093721: ($0, $1) => { return getLvglImageByName($0, UTF8ToString($1)); },  
 1093774: ($0, $1) => { return getLvglFontByName($0, UTF8ToString($1)); },  
 1093826: ($0, $1) => { return getLvglObjectNameFromIndex($0, $1); },  
 1093873: ($0, $1, $2) => { lvglObjAddStyle($0, $1, $2); },  
 1093906: ($0, $1, $2) => { lvglObjRemoveStyle($0, $1, $2); },  
 1093942: ($0, $1) => { lvglSetColorTheme($0, UTF8ToString($1)); },  
 1093987: ($0, $1, $2) => { console.log("[C:onFlowStateCreated] subscribed=" + !!$0 + " flowStateIdx=" + $1 + " flowIdx=" + $2); },  
 1094092: ($0, $1, $2, $3) => { console.log("[C:onPageChanged] previousPageId=" + $0 + " activePageId=" + $1 + " activePageIsFromStack=" + !!$2 + " previousPageIsStillOnStack=" + !!$3); },  
 1094250: () => { console.log("[C:onPageChanged] RETURNING: flow is STOPPED"); },  
 1094315: () => { console.log("[C:onPageChanged] RETURNING: same page"); },  
 1094374: ($0) => { console.log("[C:onPageChanged] not on stack, previousPageId=" + $0); },  
 1094447: ($0) => { console.log("[C:onPageChanged] closePage flowState=" + ($0 ? "OK" : "NULL")); },  
 1094529: ($0) => { console.log("[C:onPageChanged] not from stack, activePageId=" + $0); },  
 1094602: ($0) => { console.log("[C:onPageChanged] openPage flowState=" + ($0 ? "OK" : "NULL")); },  
 1094683: ($0) => { console.log("[C:onPageChanged] sending PAGE_CHANGED activePageId=" + $0); },  
 1094761: () => { console.log("[C:onPageChanged] NOT subscribed to PAGE_CHANGED!"); },  
 1094831: ($0, $1, $2, $3, $4, $5) => { return eez_mqtt_init($0, UTF8ToString($1), UTF8ToString($2), $3, UTF8ToString($4), UTF8ToString($5)); },  
 1094937: ($0, $1) => { return eez_mqtt_deinit($0, $1); },  
 1094973: ($0, $1) => { return eez_mqtt_connect($0, $1); },  
 1095010: ($0, $1) => { return eez_mqtt_disconnect($0, $1); },  
 1095050: ($0, $1, $2) => { return eez_mqtt_subscribe($0, $1, UTF8ToString($2)); },  
 1095107: ($0, $1, $2) => { return eez_mqtt_unsubscribe($0, $1, UTF8ToString($2)); },  
 1095166: ($0, $1, $2, $3) => { return eez_mqtt_publish($0, $1, UTF8ToString($2), UTF8ToString($3)); },  
 1095239: ($0, $1, $2) => { console.log("[C:getPageFlowState] assets=" + ($0 ? "OK" : "NULL") + " hasFlowDef=" + !!$1 + " pageIndex=" + $2); },  
 1095356: () => { console.log("[C:getPageFlowState] RETURNING NULL: no flowDefinition"); },  
 1095431: () => { console.log("[C:getPageFlowState] RETURNING NULL: flow is STOPPED"); },  
 1095504: ($0) => { console.log("[C:getPageFlowState] FOUND existing flowState idx=" + $0); },  
 1095580: ($0) => { console.log("[C:getPageFlowState] CREATING new flowState for pageIndex=" + $0); },  
 1095664: ($0) => { console.log("[C:getPageFlowState] created flowState=" + ($0 ? "OK" : "NULL")); }
};
...
// include: C:/QN/temcocontrols/studio-wasm-libs/lvgl-runtime/v9.5.0/../common/post.js
}
// end include: C:/QN/temcocontrols/studio-wasm-libs/lvgl-runtime/v9.5.0/../common/post.js
