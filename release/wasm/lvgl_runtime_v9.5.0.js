...
var ASM_CONSTS = {
  1093152: ($0) => { startToDebuggerMessage($0); },  
 1093184: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1093259: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1093334: ($0) => { finishToDebuggerMessage($0); },  
 1093367: ($0, $1) => { lvglCreateScreen($0, $1); },  
 1093397: ($0, $1) => { lvglDeleteScreen($0, $1); },  
 1093427: ($0) => { lvglScreenTick($0); },  
 1093451: ($0, $1, $2, $3) => { lvglOnEventHandler($0, $1, $2, $3); },  
 1093491: ($0, $1) => { return getLvglScreenByName($0, UTF8ToString($1)); },  
 1093545: ($0, $1) => { return getLvglObjectByName($0, UTF8ToString($1)); },  
 1093599: ($0, $1) => { return getLvglGroupByName($0, UTF8ToString($1)); },  
 1093652: ($0, $1) => { return getLvglStyleByName($0, UTF8ToString($1)); },  
 1093705: ($0, $1) => { return getLvglImageByName($0, UTF8ToString($1)); },  
 1093758: ($0, $1) => { return getLvglFontByName($0, UTF8ToString($1)); },  
 1093810: ($0, $1) => { return getLvglObjectNameFromIndex($0, $1); },  
 1093857: ($0, $1, $2) => { lvglObjAddStyle($0, $1, $2); },  
 1093890: ($0, $1, $2) => { lvglObjRemoveStyle($0, $1, $2); },  
 1093926: ($0, $1) => { lvglSetColorTheme($0, UTF8ToString($1)); },  
 1093971: ($0, $1, $2, $3, $4, $5) => { return eez_mqtt_init($0, UTF8ToString($1), UTF8ToString($2), $3, UTF8ToString($4), UTF8ToString($5)); },  
 1094077: ($0, $1) => { return eez_mqtt_deinit($0, $1); },  
 1094113: ($0, $1) => { return eez_mqtt_connect($0, $1); },  
 1094150: ($0, $1) => { return eez_mqtt_disconnect($0, $1); },  
 1094190: ($0, $1, $2) => { return eez_mqtt_subscribe($0, $1, UTF8ToString($2)); },  
 1094247: ($0, $1, $2) => { return eez_mqtt_unsubscribe($0, $1, UTF8ToString($2)); },  
 1094306: ($0, $1, $2, $3) => { return eez_mqtt_publish($0, $1, UTF8ToString($2), UTF8ToString($3)); }
};
