...
var ASM_CONSTS = {
  1069584: ($0) => { startToDebuggerMessage($0); },  
 1069616: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1069691: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1069766: ($0) => { finishToDebuggerMessage($0); },  
 1069799: ($0, $1) => { lvglCreateScreen($0, $1); },  
 1069829: ($0, $1) => { lvglDeleteScreen($0, $1); },  
 1069859: ($0) => { lvglScreenTick($0); },  
 1069883: ($0, $1, $2, $3) => { lvglOnEventHandler($0, $1, $2, $3); },  
 1069923: ($0, $1) => { return getLvglScreenByName($0, UTF8ToString($1)); },  
 1069977: ($0, $1) => { return getLvglObjectByName($0, UTF8ToString($1)); },  
 1070031: ($0, $1) => { return getLvglGroupByName($0, UTF8ToString($1)); },  
 1070084: ($0, $1) => { return getLvglStyleByName($0, UTF8ToString($1)); },  
 1070137: ($0, $1) => { return getLvglImageByName($0, UTF8ToString($1)); },  
 1070190: ($0, $1) => { return getLvglFontByName($0, UTF8ToString($1)); },  
 1070242: ($0, $1) => { return getLvglObjectNameFromIndex($0, $1); },  
 1070289: ($0, $1, $2) => { lvglObjAddStyle($0, $1, $2); },  
 1070322: ($0, $1, $2) => { lvglObjRemoveStyle($0, $1, $2); },  
 1070358: ($0, $1) => { lvglSetColorTheme($0, UTF8ToString($1)); },  
 1070403: ($0, $1, $2, $3, $4, $5) => { return eez_mqtt_init($0, UTF8ToString($1), UTF8ToString($2), $3, UTF8ToString($4), UTF8ToString($5)); },  
 1070509: ($0, $1) => { return eez_mqtt_deinit($0, $1); },  
 1070545: ($0, $1) => { return eez_mqtt_connect($0, $1); },  
 1070582: ($0, $1) => { return eez_mqtt_disconnect($0, $1); },  
 1070622: ($0, $1, $2) => { return eez_mqtt_subscribe($0, $1, UTF8ToString($2)); },  
 1070679: ($0, $1, $2) => { return eez_mqtt_unsubscribe($0, $1, UTF8ToString($2)); },  
 1070738: ($0, $1, $2, $3) => { return eez_mqtt_publish($0, $1, UTF8ToString($2), UTF8ToString($3)); }
};
