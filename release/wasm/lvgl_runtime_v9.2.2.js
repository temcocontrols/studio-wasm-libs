...
var ASM_CONSTS = {
  1069664: ($0) => { startToDebuggerMessage($0); },  
 1069696: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1069771: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1069846: ($0) => { finishToDebuggerMessage($0); },  
 1069879: ($0, $1) => { lvglCreateScreen($0, $1); },  
 1069909: ($0, $1) => { lvglDeleteScreen($0, $1); },  
 1069939: ($0) => { lvglScreenTick($0); },  
 1069963: ($0, $1, $2, $3) => { lvglOnEventHandler($0, $1, $2, $3); },  
 1070003: ($0, $1) => { return getLvglScreenByName($0, UTF8ToString($1)); },  
 1070057: ($0, $1) => { return getLvglObjectByName($0, UTF8ToString($1)); },  
 1070111: ($0, $1) => { return getLvglGroupByName($0, UTF8ToString($1)); },  
 1070164: ($0, $1) => { return getLvglStyleByName($0, UTF8ToString($1)); },  
 1070217: ($0, $1) => { return getLvglImageByName($0, UTF8ToString($1)); },  
 1070270: ($0, $1) => { return getLvglFontByName($0, UTF8ToString($1)); },  
 1070322: ($0, $1) => { return getLvglObjectNameFromIndex($0, $1); },  
 1070369: ($0, $1, $2) => { lvglObjAddStyle($0, $1, $2); },  
 1070402: ($0, $1, $2) => { lvglObjRemoveStyle($0, $1, $2); },  
 1070438: ($0, $1) => { lvglSetColorTheme($0, UTF8ToString($1)); },  
 1070483: ($0, $1, $2, $3, $4, $5) => { return eez_mqtt_init($0, UTF8ToString($1), UTF8ToString($2), $3, UTF8ToString($4), UTF8ToString($5)); },  
 1070589: ($0, $1) => { return eez_mqtt_deinit($0, $1); },  
 1070625: ($0, $1) => { return eez_mqtt_connect($0, $1); },  
 1070662: ($0, $1) => { return eez_mqtt_disconnect($0, $1); },  
 1070702: ($0, $1, $2) => { return eez_mqtt_subscribe($0, $1, UTF8ToString($2)); },  
 1070759: ($0, $1, $2) => { return eez_mqtt_unsubscribe($0, $1, UTF8ToString($2)); },  
 1070818: ($0, $1, $2, $3) => { return eez_mqtt_publish($0, $1, UTF8ToString($2), UTF8ToString($3)); }
};
