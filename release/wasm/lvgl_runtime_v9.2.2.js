...
var ASM_CONSTS = {
  1069680: ($0) => { startToDebuggerMessage($0); },  
 1069712: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1069787: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1069862: ($0) => { finishToDebuggerMessage($0); },  
 1069895: ($0, $1) => { lvglCreateScreen($0, $1); },  
 1069925: ($0, $1) => { lvglDeleteScreen($0, $1); },  
 1069955: ($0) => { lvglScreenTick($0); },  
 1069979: ($0, $1, $2, $3) => { lvglOnEventHandler($0, $1, $2, $3); },  
 1070019: ($0, $1) => { return getLvglScreenByName($0, UTF8ToString($1)); },  
 1070073: ($0, $1) => { return getLvglObjectByName($0, UTF8ToString($1)); },  
 1070127: ($0, $1) => { return getLvglGroupByName($0, UTF8ToString($1)); },  
 1070180: ($0, $1) => { return getLvglStyleByName($0, UTF8ToString($1)); },  
 1070233: ($0, $1) => { return getLvglImageByName($0, UTF8ToString($1)); },  
 1070286: ($0, $1) => { return getLvglFontByName($0, UTF8ToString($1)); },  
 1070338: ($0, $1) => { return getLvglObjectNameFromIndex($0, $1); },  
 1070385: ($0, $1, $2) => { lvglObjAddStyle($0, $1, $2); },  
 1070418: ($0, $1, $2) => { lvglObjRemoveStyle($0, $1, $2); },  
 1070454: ($0, $1) => { lvglSetColorTheme($0, UTF8ToString($1)); },  
 1070499: ($0, $1, $2) => { console.log("[C:onFlowStateCreated] subscribed=" + !!$0 + " flowStateIdx=" + $1 + " flowIdx=" + $2); },  
 1070604: ($0, $1, $2, $3) => { console.log("[C:onPageChanged] previousPageId=" + $0 + " activePageId=" + $1 + " activePageIsFromStack=" + !!$2 + " previousPageIsStillOnStack=" + !!$3); },  
 1070762: () => { console.log("[C:onPageChanged] RETURNING: flow is STOPPED"); },  
 1070827: () => { console.log("[C:onPageChanged] RETURNING: same page"); },  
 1070886: ($0) => { console.log("[C:onPageChanged] not on stack, previousPageId=" + $0); },  
 1070959: ($0) => { console.log("[C:onPageChanged] closePage flowState=" + ($0 ? "OK" : "NULL")); },  
 1071041: ($0) => { console.log("[C:onPageChanged] not from stack, activePageId=" + $0); },  
 1071114: ($0) => { console.log("[C:onPageChanged] openPage flowState=" + ($0 ? "OK" : "NULL")); },  
 1071195: ($0) => { console.log("[C:onPageChanged] sending PAGE_CHANGED activePageId=" + $0); },  
 1071273: () => { console.log("[C:onPageChanged] NOT subscribed to PAGE_CHANGED!"); },  
 1071343: ($0, $1, $2, $3, $4, $5) => { return eez_mqtt_init($0, UTF8ToString($1), UTF8ToString($2), $3, UTF8ToString($4), UTF8ToString($5)); },  
 1071449: ($0, $1) => { return eez_mqtt_deinit($0, $1); },  
 1071485: ($0, $1) => { return eez_mqtt_connect($0, $1); },  
